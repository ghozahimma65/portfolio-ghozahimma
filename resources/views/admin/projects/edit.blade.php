                ...
                <div class="glass-panel p-4 mb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="title" name="title" class="form-control form-control-admin w-100 @error('title') is-invalid @enderror" placeholder="e.g. DEVO IoT Monitoring" value="{{ old('title', $project->title) }}" required>
                            @error('title')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="slug" name="slug" class="form-control form-control-admin w-100 @error('slug') is-invalid @enderror" placeholder="e.g. devo-iot-monitoring" value="{{ old('slug', $project->slug) }}" required>
                            @error('slug')
                                <div class="invalid-feedback d-block small mt-1 text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="role" name="role" class="form-control form-control-admin w-100 @error('role') is-invalid @enderror" placeholder="e.g. Lead IoT Developer" value="{{ old('role', $project->role) }}">
                            @error('role')
                                <div class="invalid-feedback d-block small mt-1 text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="duration" name="duration" class="form-control form-control-admin w-100 @error('duration') is-invalid @enderror" placeholder="e.g. 3 Months" value="{{ old('duration', $project->duration) }}">
                            @error('duration')
                                <div class="invalid-feedback d-block small mt-1 text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="url" id="github_url" name="github_url" class="form-control form-control-admin w-100 @error('github_url') is-invalid @enderror" placeholder="e.g. https://github.com/ghozahimma65/project" value="{{ old('github_url', $project->github_url) }}">
                            @error('github_url')
                                <div class="invalid-feedback d-block small mt-1 text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="url" id="demo_url" name="demo_url" class="form-control form-control-admin w-100 @error('demo_url') is-invalid @enderror" placeholder="e.g. https://project.com" value="{{ old('demo_url', $project->demo_url) }}">
                            @error('demo_url')
                                <div class="invalid-feedback d-block small mt-1 text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" id="short_description" name="short_description" class="form-control form-control-admin w-100 @error('short_description') is-invalid @enderror" placeholder="A brief 1-2 sentence overview of the project." value="{{ old('short_description', $project->short_description) }}">
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="description" name="description" rows="6" class="form-control form-control-admin w-100 @error('description') is-invalid @enderror" placeholder="Describe the project overview and background details in depth..." required>{{ old('description', $project->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback d-block small mt-1 text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="glass-panel p-4 mb-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="problem" name="problem" rows="3" class="form-control form-control-admin w-100 @error('problem') is-invalid @enderror" placeholder="Define the core bottleneck or security failure that needed solving...">{{ old('problem', $project->problem) }}</textarea>
                            @error('problem')
                                <div class="invalid-feedback d-block small mt-1 text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="solution" name="solution" rows="3" class="form-control form-control-admin w-100 @error('solution') is-invalid @enderror" placeholder="Describe your technical architecture implementation...">{{ old('solution', $project->solution) }}</textarea>
                            @error('solution')
                                <div class="invalid-feedback d-block small mt-1 text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="result" name="result" rows="3" class="form-control form-control-admin w-100 @error('result') is-invalid @enderror" placeholder="Highlight analytical metrics, speed improvements, or authentication success percentages...">{{ old('result', $project->result) }}</textarea>
                            @error('result')
                                <div class="invalid-feedback d-block small mt-1 text-danger">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="glass-panel p-4 mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="order" name="order" class="form-control form-control-admin w-100 @error('order') is-invalid @enderror" value="{{ old('order', $project->order) }}" min="0" required>
                        @error('order')
                            <div class="invalid-feedback d-block small mt-1 text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-check mb-3">
                        <input class="form-check-input bg-transparent border-secondary" type="checkbox" name="featured" id="featured" value="1" {{ old('featured', $project->featured) ? 'checked' : '' }}>
                ...
                <div class="glass-panel p-4 mb-4">
                    ...
                    @if($project->image_path)
                        <div class="mb-3 text-center" id="current-thumbnail-preview">
                    ...
                    <div class="mb-3">
                        <label class="form-label text-secondary small fw-bold">Change Thumbnail</label>
                        <div class="upload-dropzone p-4 text-center border border-dashed rounded cursor-pointer" id="thumbnail-dropzone">
                            ...
                            <span class="small text-secondary d-block">Drag & drop new thumbnail or <span class="text-primary fw-bold">browse</span></span>
                    ...
                    @if($project->gallery_images && count($project->gallery_images) > 0)
                        <div class="mb-3" id="current-gallery-preview">
                            <span class="text-secondary small d-block mb-2">Current Gallery Images</span>
                            <div class="row g-2">
                                @foreach($project->gallery_images as $gimg)
                                    <div class="col-4 text-center">
                                        <img src="{{ $gimg && str_starts_with($gimg, 'http') ? $gimg : asset($gimg) }}" alt="" style="width: 100%; height: 60px; object-fit: contain; border: 1px solid var(--border-color); border-radius: 4px; padding: 2px; background: rgba(0,0,0,0.2);">
                                    </div>
                                @endforeach
                            </div>
                        </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label text-secondary small fw-bold">Change Gallery Images</label>
                        <div class="upload-dropzone p-4 text-center border border-dashed rounded cursor-pointer" id="gallery-dropzone">
                            ...
                            <span class="small text-secondary d-block">Drag & drop new images or <span class="text-primary fw-bold">browse</span></span>
                            <input type="file" id="gallery" name="gallery[]" class="d-none" accept="image/*" multiple>
                        </div>
                        <small class="text-muted d-block mt-1" style="font-size: 0.7rem;">Uploading new files will overwrite current gallery carousels.</small>
                        @error('gallery')
                            <div class="invalid-feedback d-block small mt-1 text-danger">{{ $message }}</div>
                        @enderror
                        <div id="gallery-preview-container" class="mt-3 d-none">
                            <span class="text-secondary small d-block mb-2">New Gallery Upload Preview</span>
                ...
                <div class="glass-panel p-4 mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="seo_title" name="seo_title" class="form-control form-control-admin w-100 @error('seo_title') is-invalid @enderror" placeholder="Search page title override" value="{{ old('seo_title', $project->seo_title) }}">
                        @error('seo_title')
                            <div class="invalid-feedback d-block small mt-1 text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="seo_description" name="seo_description" rows="3" class="form-control form-control-admin w-100 @error('seo_description') is-invalid @enderror" placeholder="Meta description overrides">{{ old('seo_description', $project->seo_description) }}</textarea>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        initializeTagInput({
            ...
            initialValues: {!! json_encode(old('tech_stack', $project->tech_stack ?? [])) !!}
        });
        ...
        initializeTagInput({
            ...
            initialValues: {!! json_encode(old('features', $project->features ?? [])) !!}
        });
        ...
        initImageUpload({
            ...
            isMultiple: false,
            currentPreviewId: 'current-thumbnail-preview'
        });
        ...
        initImageUpload({
            ...
            isMultiple: true,
            currentPreviewId: 'current-gallery-preview'
        });
    });
    ...
    function initImageUpload({
        ...
        function handleSingleFile(file) {
            ...
            if (currentPreview) {
                currentPreview.style.opacity = '0.3';
            }
