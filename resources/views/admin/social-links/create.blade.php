...
<div class="container-fluid px-0">
    <div class="mb-4">
        ...
        <h1 class="fw-bold mb-1 mt-2" style="font-family: var(--font-heading); font-size: 1.75rem; letter-spacing: -0.03em;">Add Social Link</h1>
        <p class="text-secondary small mb-0">Insert dynamic external profiles reference.</p>
    </div>
        ...
        <form action="{{ route('admin.social-links.store') }}" method="POST">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" id="platform" name="platform" class="form-control form-control-admin w-100" placeholder="e.g. GitHub" value="{{ old('platform') }}" required>
                </div>

                <div class="col-md-6">
                    <label for="icon" class="form-label text-secondary small fw-bold">Bootstrap Icon Class</label>
                    <input type="text" id="icon" name="icon" class="form-control form-control-admin w-100" placeholder="e.g. bi bi-github" value="{{ old('icon') }}">
                </div>

                <div class="col-md-9">
                    <label for="url" class="form-label text-secondary small fw-bold">Profile URL</label>
                    <input type="url" id="url" name="url" class="form-control form-control-admin w-100" placeholder="https://github.com/username" value="{{ old('url') }}" required>
                </div>
                ...
                <div class="col-12 mt-4 d-flex gap-2">
                    <button type="submit" class="btn-admin btn-admin-primary flex-grow-1 justify-content-center">Create Link</button>
